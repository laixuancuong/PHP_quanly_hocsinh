            <div class="news-main">
                ...
                <div class="news">
                    <table class="list-news">
                        ...
                        <tr>
                            <td>
                                <a href="/qlhs/hs/tintuc.php?id=<?php echo $row['id_news'];?>" style="padding-left: 10px;"><i class="fa fa-question-circle" aria-hidden="true"
                                        style="margin-right: 10px"></i></a>
                            </td>
                            <td>
                                <a href="/qlhs/hs/tintuc.php?id=<?php echo $row['id_news'];?>">
