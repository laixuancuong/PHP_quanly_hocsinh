...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <title>Cổng giáo viên trường THPT chuyên đại học vinh</title>
</head>
<body>
    <div class="header">
        <div class="wrap">
                            ...
                            <div id="us" class="dropdown-content">
                                <table class="list-item" style="width: 100%">
                                    <tbody>
                                        <tr>
                                            <td colspan="2" style="text-align: center">
                                                ...
                                                <span id="lbFullName" class="fullName"><b>
                                                    <?php 
                                                           if (isset($_SESSION['user_gv']) && $name){
                                                            foreach($name as $row){
                                                               echo "".$row['hoten_dem']." ".$row['ten_gv']."<br/>";
                                                            }
                                                           }
                                                    ?>
                                                </b></span>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="../gv/hoso.php"><i class="fa fa-address-card" aria-hidden="true"
