<?php require_once __DIR__. "/../../layouts/header.php";?>
    <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Phân công giảng dạy
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                                            ...
                                                            echo "
                                                                <tr class='odd gradeX'>
                                                                    ...
                                                                    <td class='center' style='width: 12%'>
                                                                        ...
                                                                        <a class='btn btn-xs btn-danger' align='center' href='delete.php?id=".$row['mapc']."'> <i class='fa fa-times'></i> Xoá</a>
                                                                    </td>
                                                                </tr>
                                                                ";
                                                                $stt ++;
