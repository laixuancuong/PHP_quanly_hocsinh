        ...
        <div class="list-main">
            <div class="list-row">
                ...
                <div class="btn-control">
                    ...
                    <button class="btn-ct info" name="add-gv_lop">Thêm</button>
                </div>
            </form>
            <?php
                if(isset($_POST['searchHS'])){
                    $search = "search";
                    $sql_dl = "SELECT * FROM phancong_cn pccn INNER JOIN lop l ON l.malh = pccn.malh INNER JOIN phancong_lh pclh ON pclh.id_pc_cn = pccn.id_pc_cn INNER JOIN hocsinh hs ON hs.mahs = pclh.mahs WHERE pccn.magv = ".$_SESSION['user_gv']." AND l.malh = ".$_POST['malop']."";
